...
```
cd existing_repo
git remote add origin https://git.cs.dal.ca/kaila/csci-4177-saas-siksha-assignment-sub.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.cs.dal.ca/kaila/csci-4177-saas-siksha-assignment-sub/-/settings/integrations)
